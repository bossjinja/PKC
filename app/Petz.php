...
class Petz extends Model
{
    ...
    protected $rules = [
        'prefix1_id' => 'required_without_all:prefix2_id,suffix_id',
        'prefix2_id' => 'required_without_all:prefix1_id,suffix_id',
        'suffix_id' => 'required_without_all:prefix1_id,prefix2_id',
        'showname' => 'required',
        'callname' => 'required',
        'breed_id' => 'required',
        'sex' => 'required',
