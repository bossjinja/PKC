    ...
    <form method="POST" action="{{ route('storepet') }}" enctype="multipart/form-data" class="ui form">
      ...
      <div class="four fields">
        <div class="three wide field">
          <label for="prefix1_id">Prefix</label>
          <select name="prefix1_id" id="prefix1" class="ui dropdown sn">
            <option value=""></option>
        ...
        <div class="three wide field">
          <label for="prefix2_id">Prefix</label>
          <select name="prefix2_id" id="prefix2" class="ui dropdown sn">
            <option value=""></option>
            @foreach ($prefixes as $prefix)
              <option value="{{ $prefix->id }}" suffix="{{ $prefix->suffix_possessive }}" prefix="{{ $prefix->prefix_possessive }}">{{ $prefix->prefix }}</option>
            @endforeach
        ...
        <div class="three wide field">
          ...
          <select name="suffix_id" id="suffix" class="ui dropdown sn">
            <option value=""></option>
            @foreach ($prefixes as $prefix)
              <option value="{{ $prefix->id }}" suffix="{{ $prefix->suffix_possessive }}" prefix="{{ $prefix->prefix_possessive }}">{{ $prefix->prefix }}</option>
            @endforeach
